...
if __name__ == "__main__":
    ...
    cluster_color = { 0: '#ff595e', 
                      ...
                      7: '#4267ac',
                      8: '#6a4c93',
                      9: '#b5a6c9'} # red, orange, yellow, light green, green, turqouise, blue, dark blue, magenta, lavender
    # check human colour https://www.w3schools.com/colors/colors_hexadecimal.asp
    human_color =  {'#ff595e': 'red', 
                    '#ff924c': 'orange', 
                    '#ffca3a': 'yellow',
                    '#c5ca30': 'light green',
                    '#8ac926': 'green',
    ...
    ax.set_title('Clustering on ' + args.tag, fontsize = 15)
